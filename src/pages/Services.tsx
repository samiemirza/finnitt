...
const Services: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="relative w-full">
          ...
          <div className="md:absolute md:inset-0">
            <div className="max-w-9xl mx-auto h-full px-4 sm:px-6 lg:px-16 flex items-center justify-start">
              <div className="max-w-3xl py-8 md:py-16 md:-mt-44">
                <motion.h1
      ...
      <section className="pt-12 md:pt-24 pb-16 md:pb-28 bg-white">
        <div className="max-w-9xl mx-auto px-4 sm:px-6 lg:px-16">
          <div className="text-center mb-8 md:mb-14">
            ...
            <motion.p
              ...
              className="text-base sm:text-lg md:text-xl text-gray-600 mt-3 md:mt-4 max-w-3xl mx-auto"
            >
