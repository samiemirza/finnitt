...
const About: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white pt-36">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="bg-gradient-to-r from-finnitt-teal to-finnitt-cyan text-white px-8 py-4 rounded-lg font-semibold text-lg shadow-xl hover:shadow-2xl transition-all duration-300"
              >
      ...
      {/* Values Section */}
      <section className="py-24 relative overflow-hidden" style={{ backgroundColor: '#0CC0DF' }}>
        <div className="relative max-w-9xl mx-auto px-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="group bg-white rounded-2xl p-8 shadow-xl hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 min-h-[360px]">
              ...
              <h3 className="text-xl font-bold text-gray-900 text-center mb-4">Impact over Hype</h3>
            ...
            <div className="group bg-white rounded-2xl p-8 shadow-xl hover:shadow-2xl hover:-translate-y-2 transition-all duration-300">
              ...
              <h3 className="text-xl font-bold text-gray-900 text-center mb-4">Secure by Default</h3>
              <p className="text-gray-600 text-sm leading-relaxed text-center">
            ...
            <div className="group bg-white rounded-2xl p-8 shadow-xl hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 min-h-[360px]">
              ...
              <h3 className="text-xl font-bold text-gray-900 text-center mb-4">Responsible AI</h3>
              <p className="text-gray-600 text-sm leading-relaxed text-center">
            ...
            <div className="group bg-white rounded-2xl p-8 shadow-xl hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 min-h-[360px]">
              ...
              <h3 className="text-xl font-bold text-gray-900 text-center mb-4">Production-Ready, Not Prototype</h3>
              <p className="text-gray-600 text-sm leading-relaxed text-center">
            ...
            <div className="group bg-white rounded-2xl p-8 shadow-xl hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 min-h-[360px]">
              ...
              <h3 className="text-xl font-bold text-gray-900 text-center mb-4">Open & Portable</h3>
              <p className="text-gray-600 text-sm leading-relaxed text-center">
            ...
            <div className="group bg-white rounded-2xl p-8 shadow-xl hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 min-h-[360px]">
              ...
              <h3 className="text-xl font-bold text-gray-900 text-center mb-4">Candor & Partnership</h3>
              <p className="text-gray-600 text-sm leading-relaxed text-center">
